...
<div class="w-full max-w-3xl bg-white p-10 shadow-xl rounded-2xl">
    <h2 class="text-2xl font-semibold mb-8 text-center text-gray-800">Create Your Account</h2>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-6">
            ...
            <input id="name" type="text" name="name" :value="old('name')" class="w-full mt-3 px-5 py-3 border border-gray-300 rounded-lg focus:ring-4 focus:ring-indigo-500 focus:outline-none bg-gray-50 text-gray-800" required autofocus autocomplete="name">
            @error('name')
        ...
        <div class="mb-6">
            ...
            <input id="email" type="email" name="email" :value="old('email')" class="w-full mt-3 px-5 py-3 border border-gray-300 rounded-lg focus:ring-4 focus:ring-indigo-500 focus:outline-none bg-gray-50 text-gray-800" required autocomplete="username">
            @error('email')
                <p class="text-sm text-red-500 mt-2">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <input id="password" type="password" name="password" class="w-full mt-3 px-5 py-3 border border-gray-300 rounded-lg focus:ring-4 focus:ring-indigo-500 focus:outline-none bg-gray-50 text-gray-800" required autocomplete="new-password">
            @error('password')
                <p class="text-sm text-red-500 mt-2">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <input id="password_confirmation" type="password" name="password_confirmation" class="w-full mt-3 px-5 py-3 border border-gray-300 rounded-lg focus:ring-4 focus:ring-indigo-500 focus:outline-none bg-gray-50 text-gray-800" required autocomplete="new-password">
        ...
        <div class="flex items-center justify-between mt-8">
            ...
            <a href="{{ route('login') }}" class="text-base text-indigo-500 hover:text-indigo-400">Already registered?</a>
        </div>
    </form>
