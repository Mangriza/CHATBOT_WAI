...
<div class="max-w-2xl mx-auto bg-white p-10 shadow-2xl rounded-lg flex flex-col items-center">
    ...
    <form method="POST" action="{{ route('register') }}" class="w-full">
        ...
        <div class="mb-6 relative">
            <label for="name" class="block text-sm font-semibold text-gray-500">Name</label>
            <input id="name" type="text" name="name" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none bg-gray-100 text-black" required autofocus autocomplete="name">
            @error('name')
...
<div class="mb-6 relative">
    ...
    @enderror
        ...
        <!-- Confirm Password -->
        <div class="mb-6 relative">
            <label for="password_confirmation" class="block text-sm font-semibold text-gray-500">Confirm Password</label>
                <div class="relative flex items-center">
            <input id="password_confirmation" type="password" name="password_confirmation" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none bg-gray-100 text-black" required autocomplete="new-password">
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <a href="{{ route('login') }}" class="text-sm text-indigo-400 hover:text-indigo-300">Already Registered?</a>
        </div>
    </form>
</div>
