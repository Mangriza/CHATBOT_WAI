...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <!-- Main Section for Confirm Password -->
        ...
        <div class="max-w-9xl mx-auto">
            <div class="flex items-center justify-center space-x-12">
                ...
                <div class="w-full max-w-3xl bg-white p-10 shadow-xl rounded-2xl">
                    <h2 class="text-2xl font-semibold mb-8 text-center text-gray-800">Confirm Your Password</h2>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input id="password" type="password" name="password" class="w-full mt-3 px-5 py-3 border border-gray-300 rounded-lg focus:ring-4 focus:ring-indigo-500 focus:outline-none bg-gray-50 text-gray-800" required autocomplete="current-password" />
                            @error('password')
